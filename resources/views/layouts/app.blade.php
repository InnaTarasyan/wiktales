...
<head>
    ...
    <script type="text/javascript">
        ...
        })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=105086787', 'ym');

        ym(105086787, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", accurateTrackBounce:true, trackLinks:true});
    </script>
    <noscript><div><img src="https://mc.yandex.ru/watch/105086787" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
    <!-- /Yandex.Metrika counter -->
    ...
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        })(window,document,'script','dataLayer','GTM-NFBGDP3R');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NFBGDP3R"
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <p class="text-gray-600 text-sm max-w-md">
                        Литературное собрание, исследующее мифологическое сознание и экзистенциальные границы. 
                        От древнегреческих архетипов до китайской поэзии, от символистских драм до экспериментальной прозы — 
                        каждое произведение открывает новые измерения человеческого опыта.
                    </p>
                </div>
